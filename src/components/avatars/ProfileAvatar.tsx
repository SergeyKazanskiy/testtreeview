...
export const ProfileAvatar: React.FC<AvatarProps> = ({ size = 40, source, rounded = false, containerStyle, onPress }) => {
  const radius = rounded ? size / 2 : 8;
  const imageStyle: ImageStyle = { width: size, height: size, borderRadius: radius};
